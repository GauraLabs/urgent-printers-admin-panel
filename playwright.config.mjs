...
// (urgent-printers-admin-panel/urgent-printers-admin-panel/...). Default config discovery at
// the repo root (what this file provides) sidesteps that bug entirely — see
// pipeline/README.md's "Known infra findings" for the full diagnosis.
//
